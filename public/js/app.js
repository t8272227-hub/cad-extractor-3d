...
function _symInit(){
  ...
  _symLegend();
  // Draggable panel (sym-panel is optional - only if present in DOM)
...
function sbUpdateSnap(){
  // Sync status-bar checkboxes → snap panel checkboxes
...
var sdpSelectType=_snpSelectType;
